...
<div class="box">
    <h3>添加新闻</h3>
    <form action="/new/addNews" method="post" enctype="multipart/form-data">
        <table class="form-table">
            ...
            <tr>
                <td>新闻标题</td>
                <td colspan="3" class="control">
                    <input type="text" name="n_title" placeholder="填写标题" style="width: 100%;">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>作者</td>
                <td colspan="3" class="control">
                    <input type="text" name="n_author" placeholder="填写作者">
                </td>
            </tr>
            <tr>
                <td>点赞数</td>
            ...
            <tr>
                <td>新闻内容</td>
                <td colspan="3" class="control">
                    <textarea style="resize: none" class="p100" name="n_content" placeholder="填写新闻内容"></textarea>
                </td>
            </tr>
        </table>
        <div class="buttons">
