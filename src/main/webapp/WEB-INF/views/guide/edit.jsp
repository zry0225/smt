...
<div class="box">
    <h3>修改指南信息</h3>
    <form action="/guide/editGuide" method="post">
        <table class="form-table">
            <tr>
                <td>标题</td>
                <td colspan="3" class="control">
                    <input type="text" name="g_title" placeholder="填写标题" value="${guide.g_title}">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>指南内容</td>
                <td colspan="3" class="control">
                    <textarea style="resize: none" class="p100" name="g_content" placeholder="填写指南内容">${guide.g_content}</textarea>
                </td>
            </tr>
        </table>
        <div class="buttons">
        ...
        <input type="hidden" name="g_id" value="${guide.g_id}">
    </form>
</div>
</body>
</html>
