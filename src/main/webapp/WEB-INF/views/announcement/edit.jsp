...
<div class="box">
    <h3>修改公告</h3>
    <form action="/announce/editAnnounce" method="post" enctype="multipart/form-data">
        <table class="form-table">
            <tr>
                ...
                <td colspan="3" class="control">
                    ...
                    <input type="hidden" name="oldImg" value="${announcement.ac_mainImg}">
                </td>
            </tr>
            <tr>
                <td>公告标题</td>
                <td colspan="3" class="control">
                    <input type="text" name="ac_title" placeholder="填写公告标题" value="${announcement.ac_title}" style="width: 100%">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>作者</td>
                <td colspan="3" class="control">
                    <input type="text" name="ac_author" placeholder="填写作者" value="${announcement.ac_author}">
                </td>
            </tr>
            ...
            <tr>
                <td>公告内容</td>
                <td colspan="3" class="control">
                    <textarea style="resize: none" class="p100" name="ac_context" placeholder="填写公告内容">${announcement.ac_context}</textarea>
                </td>
            </tr>
        </table>
        <div class="buttons">
        ...
        <input type="hidden" name="ac_id" value="${announcement.ac_id}">
    </form>
</div>
